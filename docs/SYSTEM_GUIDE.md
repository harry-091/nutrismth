# NutriQuest System Guide

This document explains the project in a way that assumes you are starting from zero. It covers:

- what the website does
- how the frontend works
- how the backend works
- how the recommendation logic works
- how the plate planner works
- what the current "ML" layer actually is
- how to turn this into a real machine learning system
- how someone would code all of this from scratch

## 1. What This Project Is

NutriQuest is a nutrition website with multiple interactive pages. A user can:

- open the home page
- play a quiz game
- read the research summary
- fill in a nutrition survey
- build a meal plate
- get recommendations and plate corrections

At a technical level, the project has two main parts:
...
- optimizing the meal plate

## 2. Important Clarification About the ML Model

Right now, this project does **not** use a trained machine learning model.

What it uses right now is:

- rules
- scoring logic
- predefined food replacement logic
...
- the code does not learn from data
- it does not train itself
- it does not improve automatically over time
- the outputs depend on logic written by the developer

This is still a valid first version.
...
- it is much safer for an MVP

But if you want a real ML system later, this codebase is already structured in a way that makes that possible.
...
- [App.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/App.jsx)
...
- plate planner state
- plate optimization results

It uses URL hash routing, meaning pages are tracked with values like:
...
This gives a multi-page feel without installing a full router library.

### Main frontend pages

The frontend pages are built from section components:

- [HeroSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/HeroSection.jsx)
- [PokeballQuizSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/PokeballQuizSection.jsx)
- [ResearchSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/ResearchSection.jsx)
- [AssessmentSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/AssessmentSection.jsx)
- [PlatePlannerSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/PlatePlannerSection.jsx)
- [ResultsSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/ResultsSection.jsx)

### API communication

The frontend calls the backend through:

- [api.js](/Users/harshshukla/Documents/New%20project/frontend/src/lib/api.js)

That file contains helper functions:
...
- the network logic stays in one place
- components stay cleaner
- backend changes are easier to manage
...
- [main.py](/Users/harshshukla/Documents/New%20project/backend/app/main.py)
...
- [models.py](/Users/harshshukla/Documents/New%20project/backend/app/models.py)
...
- [recommendations.py](/Users/harshshukla/Documents/New%20project/backend/app/services/recommendations.py)
...
- [frontend/src/App.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/App.jsx)
- [frontend/src/lib/api.js](/Users/harshshukla/Documents/New%20project/frontend/src/lib/api.js)
- [frontend/src/sections/PlatePlannerSection.jsx](/Users/harshshukla/Documents/New%20project/frontend/src/sections/PlatePlannerSection.jsx)
- [backend/app/main.py](/Users/harshshukla/Documents/New%20project/backend/app/main.py)
- [backend/app/models.py](/Users/harshshukla/Documents/New%20project/backend/app/models.py)
- [backend/app/services/recommendations.py](/Users/harshshukla/Documents/New%20project/backend/app/services/recommendations.py)
- [backend/tests/test_api.py](/Users/harshshukla/Documents/New%20project/backend/tests/test_api.py)
